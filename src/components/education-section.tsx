    ...
    <SectionWrapper id="education" className="bg-secondary/20 dark:bg-card/30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
        {education.map((edu, index) => (
          <Card key={index} className="bg-card/90 dark:bg-secondary/60 mac-shadow hover:border-accent/60 dark:hover:border-accent/70 transition-all duration-300 ease-out hover:shadow-lg transform hover:-translate-y-1"> {/* Updated hover border to accent and added transform */}
