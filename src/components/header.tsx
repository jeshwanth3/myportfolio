...
export function Header() {
 ...
 const handleNavLinkClick = useCallback((event: ReactMouseEvent<HTMLAnchorElement | HTMLButtonElement>, href: string) => {
  ...
  }, []); // Empty dependency array for useCallback as it doesn't depend on external state/props changing
...
// SheetPrimitive needs to be imported if used directly for SheetTitle
