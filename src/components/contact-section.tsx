        ...
        <CardContent className="p-6 md:p-8 text-center space-y-6"> {/* Increased spacing */}
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 flex-wrap">
            ...
            <a href={linkedInUrl} target="_blank" rel="noopener noreferrer">
              <Button variant="outline" size="lg" className="shadow-sm hover:shadow-md transition-shadow hover:scale-105 transform duration-200 bg-card/50 hover:bg-accent/10 dark:bg-secondary/50 dark:hover:bg-accent/20">
