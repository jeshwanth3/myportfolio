  ...
  "fixed z-50 gap-4 bg-background/95 p-6 shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-400 data-[state=open]:duration-500 backdrop-blur-xl", // Increased blur, adjusted background opacity, adjusted durations
  {
    variants: {
      side: {
        ...
        top: "inset-x-0 top-0 border-b border-border/20 data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top rounded-b-lg", // Adjusted border
        bottom:
          "inset-x-0 bottom-0 border-t border-border/20 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom rounded-t-lg", // Adjusted border
        left: "inset-y-0 left-0 h-full w-3/4 border-r border-border/20 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm rounded-r-lg", // Adjusted border
        right:
          "inset-y-0 right-0 h-full w-3/4 border-l border-border/20 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm rounded-l-lg", // Adjusted border
      },
    },
    defaultVariants: {
      side: "right",
...
interface SheetContentProps
  extends React.ComponentPropsWithoutRef<typeof SheetPrimitive.Content>,
    VariantProps<typeof sheetVariants> {
      title: string; // Add mandatory title prop for accessibility
    }
